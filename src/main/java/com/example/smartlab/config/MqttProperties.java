...
public class MqttProperties {
    ...
    private String seatCommandTopicPrefix = "smartlab/seats/commands";
    ...
    public String getSeatCommandTopicPrefix() {
        return seatCommandTopicPrefix;
    }

    public void setSeatCommandTopicPrefix(String seatCommandTopicPrefix) {
        this.seatCommandTopicPrefix = seatCommandTopicPrefix;
    }
}
